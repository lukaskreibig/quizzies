...
export default function OurTeam() {
    ...
    return ( <
        ...
        p >
        Journalist / Development and International Relations / Global Refugee Studies <
        /p> < /
        NameSection > <
        /StorySection1Img> < /
        StorySection1 >
        ...
        <
        p >
        Authxrs exists because we want our readers to experience literature from the major regions of the non - Western world--the Caribbean,
        Latin America, sub - Saharan Africa, the Middle East, and South Asia.We offer a bridge between our culture and theirs.The editors believe that expanding the range of literature studied beyond the traditional American, Canadian, and European canonical writers will help readers better understand an increasingly interdependent world and at the same time create social awareness. <
        /p> <
        p >
        The founders of Authxrs see an opportunity to
        try to minimize the gap in equal opportunities and reach.They aim to facilitate and produce knowledge to readers interested in social, political and economic situations of these people inside and outside the geographical social cultural scope. <
        /p> < /
        MiddleSection3Text > <
        /MiddleSection3>
        ...
        p >
        As a qualified Journalist Sara has the knowledge to guide the Authxrs throughout the writing process via her journalism,
